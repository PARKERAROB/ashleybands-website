export const CLOTHING_DEADLINE = "2026-09-01T20:00:00-04:00";
export const CLOTHING_TAX_RATE = 0.07;

export const CLOTHING_CLOSED_MESSAGE =
  "The Open House clothing order closed on September 1. If your student still needs a band shirt, email Mr. Parker.";

export function isClothingOrderClosed(now = Date.now()) {
  return now > new Date(CLOTHING_DEADLINE).getTime();
}
