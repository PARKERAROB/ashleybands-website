...
// Sponsorship-family resolver — the bridge that makes the sponsorship area portal-native
// (build-spec item A) WITHOUT removing the legacy PIN login.
//
...
//   2. Legacy PIN cookie/headers — the original separate name+PIN sponsorship login still
//      works for anyone already using it.
//
