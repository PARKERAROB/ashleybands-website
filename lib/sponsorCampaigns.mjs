...
// Proposed terms for the director's pre-publication review; not yet adopted by a live release.
export const CARNEGIE_CHANGE_TERMS = "If the trip is canceled or your gift cannot be used for this purpose, the boosters will contact you about a refund or your permission to redirect the gift. Any funds remaining after trip expenses will be handled the same way.";
