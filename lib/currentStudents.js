...
export async function loadStudent360(studentId) {
  ...
  const [resourcesResult, instrumentsResult, requestsResult, attendanceResult, sponsorResult, profileResult, musicResult, otherInstrumentsResult, interestsResult, enrollmentResult, backgroundResult, supportResult, completionResult, ledgers] = await Promise.all([
  ...
  for (const result of [resourcesResult, instrumentsResult, requestsResult, attendanceResult, sponsorResult, profileResult, musicResult, otherInstrumentsResult, interestsResult, enrollmentResult, backgroundResult, supportResult, completionResult]) {
