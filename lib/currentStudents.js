...
export async function loadStudent360(studentId, access = {}) {
  ...
  const [resourcesResult, assetsResult, requestsResult, attendanceResult, sponsorResult, profileResult, musicResult, otherInstrumentsResult, interestsResult, enrollmentResult, backgroundResult, supportResult, completionResult, membershipsResult, ledgers, formsData] = await Promise.all([
  ...
  for (const result of [resourcesResult, assetsResult, requestsResult, attendanceResult, sponsorResult, profileResult, musicResult, otherInstrumentsResult, interestsResult, enrollmentResult, backgroundResult, supportResult, completionResult, membershipsResult]) {
