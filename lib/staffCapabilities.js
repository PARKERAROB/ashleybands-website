...
export const STAFF_CAPABILITIES = Object.freeze({
  PERCUSSION_PREFERENCES_READ: "percussion_preferences.read",
  ...
  // Carnegie student letter review (#106). Director decision 2026-09-24: every portal staff role
  // reviews letters. campaign_researcher is excluded: it is a no-family-data research role.
  CARNEGIE_LETTERS_REVIEW: "carnegie.letters.review",
});
