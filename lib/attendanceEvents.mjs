...
// in BandsofAHS; each id enables every projected occurrence in that calendar series.
export const ATTENDANCE_ENABLED_EVENT_IDS = new Set([
  "evt-0007", // Band Camp, week 1
  "evt-0008", // Band Camp, week 2
  "evt-0108", // Tuesday/Thursday marching rehearsals
  "evt-0009", // Football: EE Smith
  "evt-0010", // Football: Fike
  "evt-0012", // Football: Laney
  "evt-0016", // Football: New Hanover
  "evt-0020", // Football: West Brunswick
  "evt-0022" // Football: Hoggard
]);
