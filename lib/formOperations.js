...
export async function loadFormOperations() {
  ...
  const [statusResult, onboardingResult, requestResult, membershipResult, musicProfileResult, carnegieResult] = await Promise.all([
  ...
  for (const result of [statusResult, onboardingResult, requestResult, membershipResult, musicProfileResult, carnegieResult]) {
