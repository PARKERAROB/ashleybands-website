import { normalizeGiftPurpose, sameGiftRequest, CARNEGIE_CAMPAIGN } from "@/lib/sponsorCampaigns.mjs";
...
export async function createPendingGift({
  ...
  const fields = "id, invoice_id, amount_cents, business_name, tier, method, status, paypal_order_id, campaign_code, gift_kind, portal_student_id, family_id, prospect_id, business_id";
