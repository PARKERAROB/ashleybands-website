    ...
    <main className="narrow-page">
      ...
      <div style={{ marginTop: 60, borderTop: "2px solid var(--line)", paddingTop: 40 }}>
        ...
        <div style={{ fontSize: 15, lineHeight: 1.75, color: "var(--ink)" }} className="brief-body">
          ...
          <h3>Student learning and student access</h3>

          <h4>MTSS Coordinators</h4>
          ...
          <h4>CEP Meal Program Expansion</h4>
          ...
          <h4>EC Funding Formula Rollout</h4>
          ...
          <h3>Workforce and career pathways</h3>

          <h4>Be Pro Be Proud Truck</h4>
          ...
          <h4>Increased Teacher Salaries (15&ndash;24 Years Experience)</h4>
          ...
          <h4>Non-Instructional Support Staff</h4>
          ...
          <h3>Facilities and capital</h3>

          <h4>Lottery Funding for Renovation and Repair</h4>
          ...
          <h4>Statewide Public School Bond</h4>
          ...
          <h3>Calendar and finance mechanics</h3>

          <h4>Calendar Flexibility</h4>
          ...
          <h4>Funding in Arrears Model</h4>
